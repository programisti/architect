				...
				<div className="col-lg-12 posts-list">
					<div className="single-post row">
						...
						<div className="col-lg-9 col-md-9 ">
							...
							<a className="posts-title" href="blog-single.html"><h3>Astronomy Binoculars A Great Alternative</h3></a>
							<p className="excert">
								MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money
								on boot camp when you can get the MCSE study materials yourself at a fraction.
							</p>
							<a href="blog-single.html" className="primary-btn">View More</a>
						</div>
					</div>
					<div className="single-post row">
						<div className="col-lg-3  col-md-3 meta-details">
						...
						<div className="col-lg-9 col-md-9 ">
							...
							<a className="posts-title" href="blog-single.html"><h3>The Basics Of Buying A Telescope</h3></a>
							<p className="excert">
								MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money
								on boot camp when you can get the MCSE study materials yourself at a fraction.
							</p>
					...
					<div className="single-post row">
						...
						<div className="col-lg-9 col-md-9">
							...
							<a className="posts-title" href="blog-single.html"><h3>The Glossary Of Telescopes</h3></a>
							<p className="excert">
								MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money
								on boot camp when you can get the MCSE study materials yourself at a fraction.
							</p>
					...
					<div className="single-post row">
						...
						<div className="col-lg-9 col-md-9">
							...
							<a className="posts-title" href="blog-single.html"><h3>The Night Sky</h3></a>
							<p className="excert">
								MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money
								on boot camp when you can get the MCSE study materials yourself at a fraction.
							</p>
					...
					<div className="single-post row">
						...
						<div className="col-lg-9 col-md-9">
							<div className="feature-img">
								<img className="img-fluid" src="img/blog/feature-img5.jpg" alt="" />
							</div>
							<a className="posts-title" href="blog-single.html"><h3>Telescopes 101</h3></a>
							<p className="excert">
								MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money
								on boot camp when you can get the MCSE study materials yourself at a fraction.
							</p>
